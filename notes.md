...
- [x] PriceTiers will have their own table and point to a conference. Will generate and save at conference creation and on manual trigger.
  - [x] price_tier_repository implement
  - [x] conference service to generate and save price tiers at creation
