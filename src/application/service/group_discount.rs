...
pub trait GroupDiscountService: Send + Sync {
    ...
    async fn update(&self, dto: UpdateGroupDiscountRequest) -> Result<GroupDiscount, AppError>;
    async fn delete(&self, id: u64) -> Result<(), AppError>;
    async fn activate(&self, id: u64, active: bool) -> Result<GroupDiscount, AppError>;
}
