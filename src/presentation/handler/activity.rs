...
use crate::{
    application::dto::{
        activity::{ActivityResponse, CreateActivityRequest, UpdateActivityRequest},
        activity_booking::{ActivityBookingResponse, BookActivityRequest},
...
mod tests {
    ...
    use crate::{
        application::{error::AppError, service::activity::MockActivityService},
        domain::{
            error::DomainError,
            models::{
                activity::Activity,
        ...
        presentation::handler::{activity::activity_routes, utils::test_jwt},
