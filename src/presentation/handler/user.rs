...
mod tests {
    ...
    use crate::{
        application::{error::AppError, service::user::MockUserService},
        domain::models::user::User,
        presentation::handler::{user::user_routes, utils::test_jwt},
    ...
    async fn list_no_auth() {
        let app = user_routes().with_state(AppState::default());
