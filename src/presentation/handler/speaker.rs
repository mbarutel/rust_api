...
use crate::{
    application::dto::speaker::{CreateSpeakerRequest, SpeakerResponse, UpdateSpeakerRequest},
    presentation::{
        error::HandlerError,
...
mod tests {
    ...
    use crate::{
        application::{error::AppError, service::speaker::MockSpeakerService},
        domain::{error::DomainError, models::speaker::Speaker},
        presentation::handler::{speaker::speaker_routes, utils::test_jwt},
