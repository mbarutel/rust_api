...
mod tests {
    ...
    use crate::{
        application::{error::AppError, service::exhibitor::MockExhibitorService},
        domain::{error::DomainError, models::exhibitor::Exhibitor},
        presentation::handler::{exhibitor::exhibitor_routes, utils::test_jwt},
